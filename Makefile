...
CLASS_FILES+=$(CLASS_PATH)/Registers.class $(CLASS_PATH)/Context.class $(CLASS_PATH)/ContextManager.class
CLASS_FILES+=$(CLASS_PATH)/LCRSTree.class $(CLASS_PATH)/BinaryTree.class $(CLASS_PATH)/BinaryConverter.class
